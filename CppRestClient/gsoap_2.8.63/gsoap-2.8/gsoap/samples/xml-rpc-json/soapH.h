...
#define soap_instantiate__boolean soap_instantiate_byte
...
inline int soap_write__boolean(struct soap *soap, char const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || ::soap_put__boolean(soap, p, "boolean", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_PUT__boolean(struct soap *soap, const char *URL, char const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__boolean(soap, p, "boolean", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__boolean(struct soap *soap, const char *URL, char const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__boolean(soap, p, "boolean", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
#define soap_instantiate__i4 soap_instantiate_int
...
inline int soap_write__i4(struct soap *soap, int const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || ::soap_put__i4(soap, p, "i4", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_PUT__i4(struct soap *soap, const char *URL, int const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__i4(soap, p, "i4", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__i4(struct soap *soap, const char *URL, int const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__i4(soap, p, "i4", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
#define soap_instantiate__int soap_instantiate_LONG64
...
inline int soap_write__int(struct soap *soap, LONG64 const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || ::soap_put__int(soap, p, "int", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_PUT__int(struct soap *soap, const char *URL, LONG64 const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__int(soap, p, "int", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__int(struct soap *soap, const char *URL, LONG64 const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__int(soap, p, "int", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
#define soap_instantiate__double soap_instantiate_double
...
inline int soap_write__double(struct soap *soap, double const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || ::soap_put__double(soap, p, "double", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_PUT__double(struct soap *soap, const char *URL, double const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__double(soap, p, "double", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__double(struct soap *soap, const char *URL, double const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__double(soap, p, "double", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_methodCall(soap, p), 0) || ::soap_put_methodCall(soap, p, "methodCall", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_methodCall(struct soap *soap, const char *URL, struct methodCall const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_methodCall(soap, p), 0) || ::soap_put_methodCall(soap, p, "methodCall", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_methodCall(struct soap *soap, const char *URL, struct methodCall const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_methodCall(soap, p), 0) || ::soap_put_methodCall(soap, p, "methodCall", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_methodCall(struct soap *soap, const char *URL, struct methodCall *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_methodCall(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_methodCall(struct soap *soap, struct methodCall *p)
{
	if (::soap_read_methodCall(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_fault(soap, p), 0) || ::soap_put_fault(soap, p, "fault", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_fault(struct soap *soap, const char *URL, struct fault const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_fault(soap, p), 0) || ::soap_put_fault(soap, p, "fault", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_fault(struct soap *soap, const char *URL, struct fault const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_fault(soap, p), 0) || ::soap_put_fault(soap, p, "fault", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_fault(struct soap *soap, const char *URL, struct fault *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_fault(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_fault(struct soap *soap, struct fault *p)
{
	if (::soap_read_fault(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_methodResponse(soap, p), 0) || ::soap_put_methodResponse(soap, p, "methodResponse", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_methodResponse(struct soap *soap, const char *URL, struct methodResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_methodResponse(soap, p), 0) || ::soap_put_methodResponse(soap, p, "methodResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_methodResponse(struct soap *soap, const char *URL, struct methodResponse const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_methodResponse(soap, p), 0) || ::soap_put_methodResponse(soap, p, "methodResponse", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_methodResponse(struct soap *soap, const char *URL, struct methodResponse *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_methodResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_methodResponse(struct soap *soap, struct methodResponse *p)
{
	if (::soap_read_methodResponse(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_param(soap, p), 0) || ::soap_put_param(soap, p, "param", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_param(struct soap *soap, const char *URL, struct param const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_param(soap, p), 0) || ::soap_put_param(soap, p, "param", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_param(struct soap *soap, const char *URL, struct param const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_param(soap, p), 0) || ::soap_put_param(soap, p, "param", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_param(struct soap *soap, const char *URL, struct param *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_param(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_param(struct soap *soap, struct param *p)
{
	if (::soap_read_param(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_params(soap, p), 0) || ::soap_put_params(soap, p, "params", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_params(struct soap *soap, const char *URL, struct params const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_params(soap, p), 0) || ::soap_put_params(soap, p, "params", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_params(struct soap *soap, const char *URL, struct params const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_params(soap, p), 0) || ::soap_put_params(soap, p, "params", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_params(struct soap *soap, const char *URL, struct params *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_params(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_params(struct soap *soap, struct params *p)
{
	if (::soap_read_params(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize__array(soap, p), 0) || ::soap_put__array(soap, p, "array", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT__array(struct soap *soap, const char *URL, struct _array const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__array(soap, p), 0) || ::soap_put__array(soap, p, "array", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__array(struct soap *soap, const char *URL, struct _array const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__array(soap, p), 0) || ::soap_put__array(soap, p, "array", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET__array(struct soap *soap, const char *URL, struct _array *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__array(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv__array(struct soap *soap, struct _array *p)
{
	if (::soap_read__array(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_data(soap, p), 0) || ::soap_put_data(soap, p, "data", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_data(struct soap *soap, const char *URL, struct data const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_data(soap, p), 0) || ::soap_put_data(soap, p, "data", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_data(struct soap *soap, const char *URL, struct data const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_data(soap, p), 0) || ::soap_put_data(soap, p, "data", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_data(struct soap *soap, const char *URL, struct data *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_data(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_data(struct soap *soap, struct data *p)
{
	if (::soap_read_data(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_member(soap, p), 0) || ::soap_put_member(soap, p, "member", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_member(struct soap *soap, const char *URL, struct member const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_member(soap, p), 0) || ::soap_put_member(soap, p, "member", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_member(struct soap *soap, const char *URL, struct member const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_member(soap, p), 0) || ::soap_put_member(soap, p, "member", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_member(struct soap *soap, const char *URL, struct member *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_member(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_member(struct soap *soap, struct member *p)
{
	if (::soap_read_member(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize__struct(soap, p), 0) || ::soap_put__struct(soap, p, "struct", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT__struct(struct soap *soap, const char *URL, struct _struct const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__struct(soap, p), 0) || ::soap_put__struct(soap, p, "struct", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__struct(struct soap *soap, const char *URL, struct _struct const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__struct(soap, p), 0) || ::soap_put__struct(soap, p, "struct", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET__struct(struct soap *soap, const char *URL, struct _struct *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__struct(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv__struct(struct soap *soap, struct _struct *p)
{
	if (::soap_read__struct(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize__base64(soap, p), 0) || ::soap_put__base64(soap, p, "base64", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT__base64(struct soap *soap, const char *URL, struct _base64 const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__base64(soap, p), 0) || ::soap_put__base64(soap, p, "base64", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__base64(struct soap *soap, const char *URL, struct _base64 const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__base64(soap, p), 0) || ::soap_put__base64(soap, p, "base64", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET__base64(struct soap *soap, const char *URL, struct _base64 *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__base64(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv__base64(struct soap *soap, struct _base64 *p)
{
	if (::soap_read__base64(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_value(soap, p), 0) || ::soap_put_value(soap, p, "value", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_value(struct soap *soap, const char *URL, struct value const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_value(soap, p), 0) || ::soap_put_value(soap, p, "value", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_value(struct soap *soap, const char *URL, struct value const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_value(soap, p), 0) || ::soap_put_value(soap, p, "value", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_GET_value(struct soap *soap, const char *URL, struct value *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_value(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_value(struct soap *soap, struct value *p)
{
	if (::soap_read_value(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
#define soap_instantiate__dateTime_DOTiso8601 soap_instantiate_string
...
inline int soap_write__dateTime_DOTiso8601(struct soap *soap, char *const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || ::soap_put__dateTime_DOTiso8601(soap, p, "dateTime.iso8601", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_PUT__dateTime_DOTiso8601(struct soap *soap, const char *URL, char *const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__dateTime_DOTiso8601(soap, p, "dateTime.iso8601", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__dateTime_DOTiso8601(struct soap *soap, const char *URL, char *const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__dateTime_DOTiso8601(soap, p, "dateTime.iso8601", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
#define soap_instantiate__string soap_instantiate_string
...
inline int soap_write__string(struct soap *soap, char *const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || ::soap_put__string(soap, p, "string", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_PUT__string(struct soap *soap, const char *URL, char *const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__string(soap, p, "string", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send__string(struct soap *soap, const char *URL, char *const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__string(soap, p, "string", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
